...
kantor_list = [
    "SCIENTIA", "GADING SERPONG", "BINONG", "LEGOK", "BSD","KELAPA DUA","AKADEMI KESEHATAN ANDALUSIA",
    "PT ITOKO SANNIN ABADI", "GLOBAL KONSULTAN", "PT. PRATAMA SOLUTION", "REGUS", "MEDANG",
    "PT. PARAMADAKSA TEKNOLOGI NUSANTARA", "AIMAN - ANUGERAH INOVASI MANUNGGAL",
    "PT GANITRI NITSAYA HARITA", "PT VALUTAC INOVASI KREASI","SAMPORA",
